...
router.put('/items/:id', auth_1.authMiddleware, cart_controller_1.cartController.updateItem);
router.delete('/items/:id', auth_1.authMiddleware, cart_controller_1.cartController.removeItem);
router.delete('/clear', auth_1.authMiddleware, cart_controller_1.cartController.clearCart);

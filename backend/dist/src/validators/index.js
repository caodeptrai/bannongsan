...
exports.productValidation = [
    ...
    (0, express_validator_1.body)('categoryId').trim().notEmpty().withMessage('ID danh mục không hợp lệ'),
...
exports.categoryValidation = [
    ...
    (0, express_validator_1.body)('slug').optional({ values: 'falsy' }).trim().matches(/^[a-z0-9-]+$/).withMessage('Slug chỉ chứa chữ thường, số và dấu gạch ngang'),
];
exports.cartItemValidation = [
    (0, express_validator_1.body)('productId').trim().notEmpty().withMessage('ID sản phẩm không hợp lệ'),
...
exports.orderValidation = [
    ...
    (0, express_validator_1.body)('items').isArray({ min: 1 }).withMessage('Đơn hàng phải có ít nhất một sản phẩm'),
    (0, express_validator_1.body)('items.*.productId').trim().notEmpty().withMessage('ID sản phẩm không hợp lệ'),
    (0, express_validator_1.body)('items.*.quantity').isInt({ min: 1 }).withMessage('Số lượng phải lớn hơn 0'),
];
...
exports.idParamValidation = [
    (0, express_validator_1.param)('id').trim().notEmpty().withMessage('ID không hợp lệ'),
];

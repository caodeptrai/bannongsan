...
class OrderService {
    assertStatusTransition(current, next) {
        ...
        const allowedTransitions = {
            ...
            [client_1.OrderStatus.CONFIRMED]: [client_1.OrderStatus.SHIPPING, client_1.OrderStatus.CANCELLED],
            [client_1.OrderStatus.SHIPPING]: [client_1.OrderStatus.COMPLETED, client_1.OrderStatus.CANCELLED],

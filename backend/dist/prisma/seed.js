...
async function main() {
    ...
    // ===================== CREATE ORDERS =====================
    const orderStatuses = [client_1.OrderStatus.PENDING, client_1.OrderStatus.CONFIRMED, client_1.OrderStatus.SHIPPING, client_1.OrderStatus.COMPLETED, client_1.OrderStatus.CANCELLED];
    const paymentStatuses = [client_1.PaymentStatus.PENDING, client_1.PaymentStatus.PAID, client_1.PaymentStatus.PAID, client_1.PaymentStatus.PAID, client_1.PaymentStatus.REFUNDED];
    const orders = [];
    for (let i = 0; i < 15; i++) {

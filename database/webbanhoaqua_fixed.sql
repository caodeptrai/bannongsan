...
-- Created: 2026-05-29
-- Fixed: updatedAt columns with proper defaults
-- =====================================================
...
('prd-001', 'Xoài Úc Premium', 'xoai-uc-premium', 'Xoài Úc hảo hạng, vị ngọt đậm đà, thịt vàng óng.', 89000.00, 99000.00, 'kg', 150, 'XU-001', true, true, 1250, 85, 4.80, 23, 'cat-001'),
('prd-002', 'Nho Đen Mỹ', 'nho-den-my', 'Nho đen không hạt nhập khẩu từ Mỹ, vị ngọt thanh, giòn tan.', 159000.00, 179000.00, 'khay 500g', 80, 'NM-002', true, true, 980, 62, 4.75, 18, 'cat-001'),
('prd-003', 'Táo Envy New Zealand', 'tao-envy-nz', 'Táo Envy New Zealand với vị ngọt đậm, giòn và nhiều nước.', 125000.00, 145000.00, 'kg', 100, 'TE-003', true, true, 756, 45, 4.90, 12, 'cat-001'),
('prd-004', 'Cherry Chile', 'cherry-chile', 'Cherry Chile đỏ đậm, căng mọng, ngọt lịm.', 189000.00, 219000.00, '500g', 60, 'CC-004', true, true, 654, 38, 4.70, 9, 'cat-001'),
('prd-005', 'Cam Valencia Tây Ban Nha', 'cam-valencia-tbn', 'Cam Valencia Tây Ban Nha nguyên vỏ, nhiều nước, vị ngọt thanh.', 75000.00, 85000.00, 'kg', 200, 'CV-005', true, true, 432, 28, 4.60, 7, 'cat-001'),
('prd-006', 'Xoài Cát Hòa Lộc', 'xoai-cat-hoa-loc', 'Xoài Cát Hòa Lộc nổi tiếng từ Miền Tây, thịt vàng đậm, ngọt dịu.', 55000.00, NULL, 'kg', 300, 'XC-006', true, true, 1876, 156, 4.85, 42, 'cat-002'),
('prd-007', 'Sầu Riêng Ri6', 'sau-rieng-ri6', 'Sầu riêng Ri6 Đắk Lắk, cơm vàng dẻo, hương vị đậm đà.', 135000.00, NULL, 'kg', 120, 'SR-007', true, true, 2345, 198, 4.95, 67, 'cat-002'),
('prd-008', 'Vú Sữa Lò Rèn', 'vu-sua-lo-ren', 'Vú sữa Lò Rèn Vĩnh Long nổi tiếng, vỏ mỏng, thịt trắng ngần.', 45000.00, NULL, 'kg', 180, 'VS-008', true, true, 1123, 89, 4.70, 25, 'cat-002'),
...
('prd-010', 'Bưởi Năm Roi Đồng Tháp', 'buoi-nam-roi', 'Bưởi Năm Roi Đồng Tháp vỏ mỏng, cùi trắng, ít xơ.', 35000.00, NULL, 'quả', 250, 'BN-010', false, true, 678, 45, 4.65, 12, 'cat-002'),
...
('prd-013', 'Mít Sấy Giòn', 'mit-say-gion', 'Mít sấy giòn từ Nam Bộ, 100% tự nhiên, không chất bảo quản.', 85000.00, 95000.00, 'túi 200g', 100, 'MSG-013', true, true, 567, 34, 4.60, 9, 'cat-003'),
('prd-014', 'Xoài Sấy Dẻo', 'xoai-say-deo', 'Xoài sấy dẻo Đắk Lắk, vị ngọt tự nhiên, mềm dai.', 72000.00, NULL, 'túi 250g', 120, 'XSD-014', false, true, 345, 23, 4.45, 6, 'cat-003'),
('prd-015', 'Hạt Điều Rang Muối', 'hat-dieu-rang-muoi', 'Hạt điều rang muối Bình Phước, rang giòn, vị đậm đà.', 145000.00, 165000.00, 'gói 500g', 80, 'HDM-015', true, true, 789, 56, 4.75, 14, 'cat-003'),
('prd-016', 'Hạt Macca Úc', 'hat-macca-uc', 'Hạt macca rang nhẹ nhập khẩu từ Úc, giòn thơm, giàu dinh dưỡng.', 225000.00, 250000.00, 'gói 300g', 50, 'HMU-016', true, true, 456, 28, 4.85, 7, 'cat-003'),
('prd-017', 'Nước Ép Cam Vàng', 'nuoc-ep-cam-vang', 'Nước ép cam nguyên chất 100%, không đường, không chất bảo quản.', 55000.00, NULL, 'chai 1L', 200, 'NEC-017', true, true, 876, 78, 4.70, 21, 'cat-004'),
('prd-018', 'Nước Ép Nho Đỏ', 'nuoc-ep-nho-do', 'Nước ép nho đỏ nhập khẩu, nguyên chất, giàu resveratrol.', 89000.00, 99000.00, 'chai 750ml', 100, 'NEN-018', false, true, 345, 23, 4.55, 6, 'cat-004'),
('prd-019', 'Sữa Hạt Điều', 'sua-hat-dieu', 'Sữa hạt điều 100% tự nhiên, không đường, thuần chay.', 125000.00, NULL, 'chai 1L', 60, 'SHD-019', true, true, 234, 15, 4.60, 4, 'cat-004'),
('prd-020', 'Giỏ Trái Cây Cao Cấp', 'gio-trai-cay-cao-cap', 'Giỏ trái cây cao cấp với 8-10 loại trái cây nhập khẩu và Việt Nam.', 890000.00, 999000.00, 'giỏ', 30, 'GTC-020', true, true, 567, 12, 4.90, 8, 'cat-005'),
('prd-021', 'Hộp Quà Trái Cây Mix', 'hop-qua-trai-cay-mix', 'Hộp quà trái cây mix với 5-6 loại trái cây đặc sản.', 550000.00, 620000.00, 'hộp', 50, 'HQT-021', true, true, 432, 18, 4.80, 5, 'cat-005'),
('prd-022', 'Giỏ Trái Cây Việt Nam', 'gio-trai-cay-vn', 'Giỏ trái cây Việt Nam cao cấp với các loại trái cây đặc sản.', 450000.00, 520000.00, 'giỏ', 40, 'GTV-022', false, true, 234, 9, 4.65, 3, 'cat-005');
...
('faq-001', 'Cửa hàng có giao hàng không?', 'Có, chúng tôi giao hàng toàn quốc. Nội thành TP.HCM giao trong 24h, các tỉnh khác 2-5 ngày.', 'giao hàng, vận chuyển, ship', 'vanchuyen', true, 10),
...
('faq-007', 'Tôi muốn liên hệ?', 'Hotline: 0901 234 567 (7:00-21:00). Email: contact@webbanhoaqua.com. Zalo: 0901 234 567. Địa chỉ: 123 Đường ABC, Quận 1, TP.HCM.', 'liên hệ, hotline, số điện thoại, email', 'lienhe', true, 4),
...
('faq-009', 'Trái cây có tươi không?', 'Tất cả trái cây tại WebBanhHoaqua được nhập hàng mới mỗi ngày, bảo quản trong kho lạnh đạt chuẩn.', 'tươi, chất lượng, tươi ngon', 'sanpham', true, 2),
